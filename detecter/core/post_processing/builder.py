...
__all__ = ['ComposePostProcess', 'build_post_processes', 'POST_PROCESSORS']
...
class ComposePostProcess(object):
    ...
    def __init__(self, process_list):
        ...
        for process in process_list:
            if isinstance(process, dict):
                operation = build_from_cfg(process, POST_PROCESSORS)
    ...
    def __call__(self, results, img_metas=None):
