...
from mmdet.cv_core.cnn import bias_init_with_prob, normal_init
from mmdet.cv_core.ops import DeformConv2d, MaskedConv2d
...
class GuidedAnchorHead(AnchorHead):
    ...
    def ga_loc_targets(self, gt_bboxes_list, featmap_sizes):
        ...
        for img_id in range(img_per_gpu):
            ...
            # 利用FPN中的roi重映射规则，将每个gt bbox确定其所应该处于的层数
            ...
            for gt_id in range(gt_bboxes.size(0)):
                ...
                # 在特征图尺度计算忽略区域，即利用ignore_ratio对gt_按照wh比例不变原则，向内缩放r2比例
                ignore_x1, ignore_y1, ignore_x2, ignore_y2 = calc_region(
                    gt_, r2, featmap_sizes[lvl])
                # 在特征图尺度计算正样本区域，即利用center_ratio对gt_按照wh比例不变原则，向内缩放r1比例
                # 并且center_ratio取值要小于ignore_ratio
