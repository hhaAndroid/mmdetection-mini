...
class SABLRetinaHead(BaseDenseHead):
    ...
    def loss_single(self, cls_score, bbox_pred, labels, label_weights,
        ...
        # regression loss
        bbox_cls_targets = bbox_cls_targets.reshape(-1, self.side_num * 4)  # 4个边，每条边包括self.side_num个桶
    ...
    def get_bboxes_single(self,
        ...
        # mlvl_confids是bbox内部分类分支的top2加权分值
        # mlvl_scores是原始分类分支输出分值
        # 内部排序是mlvl_scores×mlvl_confids
